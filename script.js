...
const updateBalanceValues = () => {
    const transectionAmounts = transactions.map(({ amount }) => amount)

    const income = getIncome(transectionAmounts)

    const total = getTotal(transectionAmounts)

    const expenses = getExpenses(transectionAmounts)
